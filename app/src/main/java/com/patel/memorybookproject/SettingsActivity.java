...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button btnChangeEmail, btnChangePassword, btnSendResetEmail, btnChangeFontFamily, btnBack, btnChangeFontSize, btnRemoveUser,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChangeFontFamily = (Button) findViewById(R.id.changeFontFamily);
        btnChangeFontSize = (Button) findViewById(R.id.changeFontSize);
...
//        signOut = (Button) findViewById(R.id.sign_out);
        ...
        btnChangeFontFamily.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((CoordinatorLayout) findViewById(R.id.fragment)).removeAllViews();
                ChangeFontFamilyFragment frag = new ChangeFontFamilyFragment();
        ...
        btnChangeFontSize.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((CoordinatorLayout) findViewById(R.id.fragment)).removeAllViews();
                ChangeFontSizeFragment frag = new ChangeFontSizeFragment();
                FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment, frag);
                transaction.commit();
            }
